      ...
      <div className="tweet">
        ...
        <div className="tweet-content">
          ...
          <div className="tweet-actions">
            <span className="tweet-action comment-icon">
              <IconAction
                icon={
                  <svg
                    width="20"
                ...
                details={tweet.actionCountComments}
                tooltiptext={"Reply"}
              />
            </span>

            <span className="tweet-action retweet-icon">
              <IconAction
                icon={
                  <svg
                    width="20"
                ...
                details={tweet.actionCountRetweets}
                tooltiptext={"Repost"}
              />
            </span>
            ...
            <span className="tweet-action like-icon">
              <IconAction
                ...
                details={tweet.actionCountLikes}
                tooltiptext={"Like"}
              />
            </span>
            ...
            <span className="tweet-action comment-icon">
              <IconAction
                ...
                details={tweet.actionCountShares}
                tooltiptext={"Share"}
              />
            </span>
          </div>
